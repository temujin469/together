      ...
      <div className='my-container'>
        <div className="container mx-auto pt-6"
          ...
          <div className='mb-6 px-5'>
            <form>
              <div className="mx-auto flex flex-col gap-5 sm:flex-row sm:justify-center sm:items-center">
                ...
                ease-in-out
                m-0
                focus:text-gray-700 focus:bg-white focus:border-color3 focus:border-2 focus:outline-none
              "
          ...
          <div className="text-start grid lg:grid-cols-4 md:grid-cols-2"
            ...
            <div className="flex flex-col items-center mb-6">
              <h5 className=" text-lg text-white mb-2.5">Хэрэглэгчдэд</h5>
            ...
            <div className="flex flex-col items-center mb-6">
              <h5 className=" text-lg text-white mb-2.5">Мэргэжилтэнүүдэд</h5>
            ...
            <div className="flex flex-col items-center mb-6">
              <h5 className=" text-lg text-white mb-2.5">Нийтлэг төрлүүд</h5>

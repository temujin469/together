...
type Props = {
  setShow: Dispatch<SetStateAction<"register" | "signin">>
}
...
function Register({ setShow }: Props) {
  ...
  return (
    <div>
      <div className="absolute top-[50%] translate-x-[-50%] z-[80] translate-y-[-50%] left-[50%] w-full  max-w-[600px] p-5">
          ...
          <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
            ...
            <form onSubmit={handleSubmit(handleRegister)}>
              ...
              <div className="text-center mt-10">
                <button
                  className="bg-gradient-to-r from-[#b936f5] to-[#f1006c] text-white active:bg-gray-700 text-sm font-bold uppercase px-6 py-4 rounded-xl shadow hover:shadow-xl outline-none focus:outline-none mr-1 mb-1 w-full"
                  type="submit"
                  style={{ transition: "all .15s ease" }}
                >
                  Бүртгүүлэх
            ...
            <div className="flex justify-end pt-3">
              <button className="hover:underline text-primary" onClick={() => setShow('signin')}>Аль хэдийн бүртгүүлсэн</button>
            </div>
          </div>
        </div>
      </div>
